    ...
    <div class="section-2">
      <div class="section-body-2">
        <div class="section-content-2 clearfix">
          消费金额
          <span class="section-value">{{Number(myOrder.amount/100).toFixed(2)}}元</span>
        </div>
        <div class="line"></div>
        <div class="section-content-3">
          <p class="section-p clearfix">
            代金券
            <span class="section-value">-50元</span>
          </p>
...
<!--           <p class="section-p margin-top-28 clearfix">
        ...
        <div class="section-content-4 clearfix">
          实付
          <span class="section-value price-text">{{Number(myOrder.realAmount/100).toFixed(2)}}元</span>
        </div>
      </div>
    </div>
